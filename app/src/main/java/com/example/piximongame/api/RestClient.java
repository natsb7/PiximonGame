...
public class RestClient {
    ...
    //private static final String BASE_URL = "http://192.168.50.181:8081"; //la ip del ordenador en clase con la api
    private static final String BASE_URL = "http://192.168.1.175:8081"; //ip ordenador casa
